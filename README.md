...
The current catalog declares `installer.codex-ai-tooling` `1.1.3` and `installer.ai-context` `1.2.5` as stable installers for Windows, Linux, and macOS.
