...
برای integration جدید OpenAI، **Responses API** و مستندات فعلی همان model را مبنا قرار دهید. Assistants API قدیمی deprecated شده و برای **۲۰۲۶-۰۸-۲۶** shutdown برنامه‌ریزی شده است؛ production جدید را روی آن شروع نکنید.
