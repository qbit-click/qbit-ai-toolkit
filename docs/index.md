...
The first implemented catalog asset is `installer.codex-ai-tooling` version `1.1.0`. It installs repository-owned AI development tooling into an existing Git work tree while preserving application dependencies, project-owned instructions, and Git index state.
